...
from dr_detection.core.data import DRDataset
from dr_detection.utils.metrics import (
    calculate_metrics_with_probs,
    plot_confusion_matrix,
    print_metrics_report,
)
from dr_detection.utils.visualizations import (
    get_gradcam_viz,
    plot_roc_curves,
)
...
def main():
    ...
    parser.add_argument('--backbone', type=str, default='resnet50', help='Model backbone (resnet50, resnet101, efficientnet_b0, efficientnet_b3, vit_b_16)')
    ...
    print(f'Evaluating at {image_size}x{image_size}')
    ...
    dataset = DRDataset(
        ...
        transform=DRDataset.get_val_transforms(image_size=(image_size, image_size)),
