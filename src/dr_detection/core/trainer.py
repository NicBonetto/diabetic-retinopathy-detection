...
from dr_detection.utils.metrics import calculate_metrics
    ...
    def fit(
        ...
        for epoch in range(num_epochs):
            ...
            if val_metrics['kappa'] > self.best_val_kappa:
                ...
                print(f'✓ Saved best model (kappa: {val_metrics["kappa"]:.4f})')
        ...
        print('\nTraining complete!')
        print(f'Best validation kappa: {self.best_val_kappa:.4f}')
        print(f'Accuracy at that epoch: {self.best_val_acc:.4f}')
